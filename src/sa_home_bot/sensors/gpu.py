...
опрашивает сразу все карты на машине, если их несколько (как было на mycraft,
пока рядом с Tesla временно стояла RTX 3060) — парсинг вынесен в чистую
функцию для тестов на фикстурах.
"""

...
# сообщением был бы заметный молчаливый разрыв. Намеренно без указания,
# ЧЕЙ голос синтезируют — референс ещё временный (решение пользователя
# 2026-08-11), да и вообще это не то, что стоит объяснять пользователю.
VOICE_SYNTH_TEXT = "<i>Ответ Альфреда сейчас озвучивают за кадром</i>"
VOICE_SYNTH_TEXT_PLAIN = "Ответ Альфреда сейчас озвучивают за кадром"

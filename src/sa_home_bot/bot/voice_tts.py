...
# синтезируется его собственный голос). Живая находка 2026-08-12: время
# синтеза примерно равно длительности итогового аудио (XTTS проговаривает
# текст, а не мгновенно его "рендерит"), поэтому статус — не "готовится"
# (будущее время, как перед стартом), а "проговаривает" здесь и сейчас —
# именно это и происходит на службе всё то время, что висит этот статус.
VOICE_SYNTH_TEXT = "<i>Альфред проговаривает ответ вслух</i>"
VOICE_SYNTH_TEXT_PLAIN = "Альфред проговаривает ответ вслух"

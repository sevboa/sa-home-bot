...
2. Портирование сервиса ноды + monitor-win (LHM), запуск вручную для отладки.
3. `install.ps1` + служба WinSW.
4. Умения управления: `apps-win` (CreateProcessAsUser), `power`; дальше —
   службы Windows и автозапуск.

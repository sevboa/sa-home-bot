...
> службы с кнопками управления; `/help` — скилы + версия). Дальнейшее
> развитие — см. раздел «Видение и дорожная карта» в конце документа.
...
3. Портирование сервиса ноды + monitor-win (LHM), запуск вручную для
   отладки (power/uptime уже готовы, см. п. 2).
4. `install.ps1` + служба WinSW.

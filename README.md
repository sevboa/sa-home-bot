...
`[swarm] failover_grace_s` тишины и возвращает её, когда основная вернулась.
...
управление нодами; `/help`, `/ping`, `/whoami` — универсальные. `/help`
показывает доступные скилы и версию бота (about).
...
`/status_full`, `/stats`, `/scan_now`, `/downtime`, `/wake`. Кнопки действий
бот строит динамически из `describe` служб; права на них — `действие@служба`

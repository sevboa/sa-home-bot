...
> **Версия:** 0.78.0 · **Статус:** ядро готово · Python 3.11+ · 1578 тестов, ruff чисто
...
pipx install "git+https://github.com/sevboa/sa-home-bot.git@v0.78.0"
...
tests/unit/                # 1578 тестов: домен, store, scan-job, proto, monitor, smoke app
```

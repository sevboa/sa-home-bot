...
> **Версия:** 0.77.0 · **Статус:** ядро готово · Python 3.11+ · 1575 тестов, ruff чисто
...
pipx install "git+https://github.com/sevboa/sa-home-bot.git@v0.77.0"
...
tests/unit/                # 1575 тестов: домен, store, scan-job, proto, monitor, smoke app
```

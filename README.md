...
> **Версия:** 0.78.1 · **Статус:** ядро готово · Python 3.11+ · 1579 тестов, ruff чисто
...
pipx install "git+https://github.com/sevboa/sa-home-bot.git@v0.78.1"
...
tests/unit/                # 1579 тестов: домен, store, scan-job, proto, monitor, smoke app
```
